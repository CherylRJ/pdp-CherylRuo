...
;;     ...)
;; Examples:
;; (define pluto1 (make-pluto 90 100 16))
;; (define pluto2 (make-pluto 90 14 16))
...
;; GIVEN: a Pluto
;; RETRUNS: true iff the pluto is facing in the specified definition
;; STRATEGY: function composition
...
;; GIVEN: a Pluto
;; RETURNS: true iff the given pluto is located futher than the room's 
...
;; RETURNS: a Pluto on the location after it moved
;; STRATEGY: structural decomposition
